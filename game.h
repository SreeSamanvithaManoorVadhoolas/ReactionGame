...
* \date 1.12.2023
*
* \brief Header file for the Reaction Game control
*
* This function handles the different states of the Reaction game, including waiting for
* a button press, displaying a random pattern, and evaluating the player's reaction time.
* The game progresses through rounds, and the player's score and reaction times are tracked.
*
* \note <notes>
...
typedef enum {
    GAME_BUTTON = 1,
    GAME_DELAY_TIMEOUT = 2
} GAME_event_t;    

volatile uint16_t  timer,button_press_time;
